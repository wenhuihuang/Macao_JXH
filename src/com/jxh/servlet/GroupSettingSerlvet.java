	...
	private void submit(HttpServletRequest request, HttpServletResponse response) throws Exception {
		...
		String message = "";
			...
			if(groupSettingRecord.getRecordID() != null && !"".equals(groupSettingRecord.getRecordID())){
				message = groupSettingRecordBiz.updateMedicalRecord(groupSettingRecord, groupSetting,groupSettingBudgetAdds,groupSettingBudgetUpdates,groupSettingBudgetDeletes,groupSettingPlanAdds,groupSettingPlanUpdates,groupSettingPlanDeletes,groupSettingRecordBudgetAdds,groupSettingRecordBudgetUpdates,groupSettingRecordBudgetDeletes,groupSettingRecordPlanAdds,groupSettingRecordPlanUpdates,groupSettingRecordPlanDeletes,groupSettingRecordPerformanceAdds,groupSettingRecordPerformanceUpdates,groupSettingRecordPerformanceDeletes);
			}else{
				message = groupSettingRecordBiz.insertMedicalRecord(groupSettingRecord, groupSetting,groupSettingBudgetAdds,groupSettingPlanAdds,groupSettingRecordBudgetAdds,groupSettingRecordPlanAdds,groupSettingRecordPerformanceAdds);
			}
