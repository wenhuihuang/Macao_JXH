...
public class FamilySupportBiz {
	...
	public String updateFamilySupport(FamilySupport familySupport, List<FamilySupportApply> familySupportApplyAdds,
			List<FamilySupportApply> familySupportApplyUpdates, List<FamilySupportApply> familySupportApplyDeletes,
		...
		if (row > 0) {
			//
			if(addFamilySupportApply(familySupport, familySupportApplyAdds)<0){
				throw new Exception("新增個案撮要失败！");
			}
			
			if(updateFamilySupportApply(familySupport, familySupportApplyUpdates)<0){
				throw new Exception("新增個案撮要失败！");
			}
			
			if(deleteFamilySupportApply(familySupport, familySupportApplyDeletes)<0){
				throw new Exception("新增個案撮要失败！");
			}
	...
	private int updateFamilySupportRecord(FamilySupport familySupport,
			List<FamilySupportRecord> familySupportRecordUpdates) throws NoSuchFieldException, SecurityException, IllegalArgumentException, IllegalAccessException, SQLException, ParseException, IOException {
	...
	private int deleteFamilySupportApply(FamilySupport familySupport, List<FamilySupportApply> familySupportApplyDeletes) throws IOException, SQLException {
	...
	private int updateFamilySupportApply(FamilySupport familySupport, List<FamilySupportApply> familySupportApplyUpdates) throws NoSuchFieldException, SecurityException, IllegalArgumentException, IllegalAccessException, SQLException, ParseException, IOException {
		if (familySupportApplyUpdates == null || familySupportApplyUpdates.size() <= 0) {
			return 1;
		}
		
		for (FamilySupportApply update : familySupportApplyUpdates) {
	...
	public String insertFamilySupport(FamilySupport familySupport, List<FamilySupportApply> familySupportApplyAdds,
	...
	private int addFamilySupportRecord(FamilySupport familySupport, List<FamilySupportRecord> familySupportRecordAdds) throws NoSuchFieldException, SecurityException, IllegalArgumentException, IllegalAccessException, SQLException, ParseException, IOException {
	...
	private int addFamilySupportApply(FamilySupport familySupport, List<FamilySupportApply> familySupportApplyAdds) throws NoSuchFieldException, SecurityException, IllegalArgumentException, IllegalAccessException, SQLException, ParseException, IOException {
		if (familySupportApplyAdds == null || familySupportApplyAdds.size() <= 0) {
			return 1;
		}
		
		for (FamilySupportApply update : familySupportApplyAdds) {
