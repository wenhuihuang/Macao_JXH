...
public class ActivitySettingBiz {
	...
	private int updateActivityRecordNew(ActivitySetting activitySetting,
			List<ActivityRecordNew> activityRecordNewUpdates) throws NoSuchFieldException, SecurityException, IllegalArgumentException, IllegalAccessException, SQLException, ParseException, IOException {
	...
	private int updateActivityApply(ActivitySetting activitySetting, List<ActivityApply> activityApplyUpdates) throws NoSuchFieldException, SecurityException, IllegalArgumentException, IllegalAccessException, SQLException, ParseException, IOException {
		if (activityApplyUpdates == null || activityApplyUpdates.size() <= 0) {
			return 1;
		}
		
		for (ActivityApply update : activityApplyUpdates) {
	...
	private int addActivityRecordNew(ActivitySetting activitySetting, List<ActivityRecordNew> activityRecordNewAdds) throws NoSuchFieldException, SecurityException, IllegalArgumentException, IllegalAccessException, SQLException, ParseException, IOException {
	...
	private int addActivityApply(ActivitySetting activitySetting, List<ActivityApply> activityApplyAdds) throws NoSuchFieldException, SecurityException, IllegalArgumentException, IllegalAccessException, SQLException, ParseException, IOException {
		if (activityApplyAdds == null || activityApplyAdds.size() <= 0) {
			return 1;
		}
		
		for (ActivityApply update : activityApplyAdds) {
