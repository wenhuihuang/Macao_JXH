...
public class SmsSendMaster implements Serializable {
	...
	public SmsSendMaster(String billMasterID, Date billDate, String billNO, String corpID, String sms, int telNOCount, int succeedQty, int failureQty, String note, String makeUserID, int state, String smsType, int fGrade ,String billDate_str,int peopleCount){
		super();
	...
	public String toString(){
		return "SmsSendMaster [billMasterID="+billMasterID+",billDate="+billDate+",billNO="+billNO+",corpID="+corpID+",sms="+sms+",telNOCount="+telNOCount+",succeedQty="+succeedQty+",failureQty="+failureQty+",note="+note+",makeUserID="+makeUserID+",state="+state+",smsType="+smsType+",fGrade="+fGrade+",billDate_str="+billDate_str+",peopleCount="+peopleCount+"]";
	}
}
