...
/** bCustCase
	...
	CASEWORKER	VARCHAR(20)
	CASESTATUS	INT(10)
	CASESOURCE	INT(10)
	CASESOURCEDETAIL	VARCHAR(32)
	CUSTID	VARCHAR(20)
	CUSTNO	VARCHAR(32)
	CUSTNEWNO	VARCHAR(32)
	ECONOMICS	VARCHAR(100)
	CASEPROBLEM	TEXT(2147483647)
	PROBLEMDATE	DATETIME(23,3)
	PROBLEMADMIN	VARCHAR(20)
	CASEREQUEST	TEXT(2147483647)
	REQUESTDATE	DATETIME(23,3)
	REQUESTADMIN	VARCHAR(20)
	CASEACTION	TEXT(2147483647)
	ACTIONDATE	DATETIME(23,3)
	ACTIONADMIN	VARCHAR(20)
	INITASSESS	INT(10)
	INITASSESSDETAIL	VARCHAR(50)
	SUGGEST	INT(10)
	HANDLER	VARCHAR(32)
	HANDLEDATE	DATETIME(23,3)
	HANDLEWAY	INT(10)
	HANDLEWAYDETAIL	VARCHAR(100)
	HANDLESUGGEST	TEXT(2147483647)
	NOTE	TEXT(2147483647)
	DISPOSEWORKER	VARCHAR(32)
