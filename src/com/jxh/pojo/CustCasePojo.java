...
public class CustCasePojo implements Serializable {
	...
	public CustCasePojo(String caseID,String caseNO,String fullName,String isMember,Date receiveDate,Date closeDate,int caseStatus
						...
						,String recordAdmin,String title,String content,String analysis,String ways,Date handleDate
						,String handleSuggest,String handleDate_str,int handleWay,String disposeWorker,String custID,String summaryID,String summaryDetail
						,String summaryNeed,String assessWorker,String background,String problem,String objective,String describe,Date talksDate,String talksDate_str
						,String talksTime,Date assessDate, String assessDate_str,Date disposeDate,String disposeDate_str,String caseSourceDetail,Date problemDate,String problemDate_str
						,String problemAdmin,Date requestDate,String requestDate_str,String requestAdmin,Date actionDate,String actionDate_str,String actionAdmin,String initAssessDetail
						,String manager,Date manageDate,String manageDate_str,String manageSuggest,String handleWayDetail,String closePeople) {
		super();
		this.caseID = caseID;
		this.caseNO = caseNO;
	...
	public String toString() {
		return "CustCasePojo [caseID="+caseID+",caseNO=" + caseNO + ", fullName=" + fullName + ", receiveDate=" + receiveDate + ", isMember="
				...
				+ ",form=" + form + ",place=" + place + ",family=" + family + ",otherMan=" + otherMan + ",times=" + times
				+ ",recordAdmin=" + recordAdmin + ",title=" + title + ",content=" + content + ",analysis=" +analysis + ",ways=" + ways + ",handleDate=" + handleDate
				+ ",handleSuggest=" + handleSuggest + ",handleDate_str=" + handleDate_str + ",handleWay=" + handleWay + ",disposeWorker=" + disposeWorker + ",summaryID=" + summaryID + ",summaryDetail=" + summaryDetail
				+ ",summaryNeed=" + summaryNeed + ",assessWorker=" + assessWorker + ",background=" + background+ ",problem=" + problem + ",objective=" +objective+ ",describe=" + describe+ ",talksDate=" +talksDate+ ",talksDate_str=" 
				+talksDate_str+ ",talksTime=" + talksTime + ",assessDate=" + assessDate + ",assessDate_str=" + assessDate_str + ",disposeDate=" +disposeDate+ ",disposeDate_str="+disposeDate_str+ ",caseSourceDetail="+caseSourceDetail
				+",problemDate="+problemDate+",problemDate_str="+problemDate_str+",problemAdmin="+problemAdmin+",requestDate="+requestDate+",requestDate_str="+requestDate_str+ ",requestAdmin="+requestAdmin+",actionDate="+actionDate+",actionDate_str="+actionDate_str
				+",actionAdmin="+actionAdmin+",initAssessDetail="+initAssessDetail+",manager="+manager+",manageDate="+manageDate+",manageDate_str="+manageDate_str+",manageSuggest="+manageSuggest+",handleWayDetail="+handleWayDetail+",closePeople="+closePeople+"]";
	}
