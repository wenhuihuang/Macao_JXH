...
public class DormitoryRecordPojo implements Serializable {
	...
	public DormitoryRecordPojo(String recordID, String custID, String recordNO, Date applyDate, Date planDate,
			int recordType, String roomNO, String groupType, Date inDate, String actProtocol, String worker,
			Date trainingBDate, Date trainingEDate, Date outDate, String task, String interactive, String ativity,
			String applyDate_str, String planDate_str, String inDate_str, String trainingBDate_str,
			String trainingEDate_str, String outDate_str, String trainingBTime, String trainingETime,
			String trainingType, String fullName, String isMember, String aPlanID, String tRecordID, String reviewID,
			String custType) {
		super();
	...
	public String toString() {
		return "DormitoryRecord [recordID=" + recordID + ",custID=" + custID + ",recordNO=" + recordNO + ",applyDate="
				+ applyDate + ",planDate=" + planDate + ",recordType=" + recordType + ",roomNO=" + roomNO
				+ ",groupType=" + groupType + ",inDate=" + inDate + ",actProtocol=" + actProtocol + ",worker=" + worker
				+ ",trainingBDate=" + trainingBDate + ",trainingEDate=" + trainingEDate + ",outDate=" + outDate
				+ ",task=" + task + ",interactive=" + interactive + ",ativity=" + ativity + ",applyDate_str="
				+ applyDate_str + ",planDate_str=" + planDate_str + ",inDate_str=" + inDate_str + ",trainingBDate_str="
				+ trainingBDate_str + ",trainingEDate_str=" + trainingEDate_str + ",outDate_str=" + outDate_str
				+ ",trainingBTime=" + trainingBTime + ",trainingETime=" + trainingETime + ",trainingType="
				+ trainingType + ",fullName=" + fullName + ",isMember=" + isMember + ",aPlanID=" + aPlanID
				+ ",tRecordID=" + tRecordID + ",reviewID=" + reviewID + ",custType=" + custType + "]";
	}
}
