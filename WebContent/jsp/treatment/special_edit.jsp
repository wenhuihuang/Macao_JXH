...
<script type="text/javascript">
	...
	function itemclick(item){
		switch (item.id){
			...
			break;
			case "back":
				location.href="jsp/treatment/special_list.jsp";
			break;
		}
	...
	$(function(){
		if($("#treatmentID").val() != "" && $("#treatmentID").val() != 'null' && $("#treatmentID").val() != 'undefined'){
			setTabTitle(parent.$("#framecenter"),"特別治療編輯")
		}else{
			setTabTitle(parent.$("#framecenter"),"特別治療新增")
		}
...
<body>
	...
	<input type="hidden" name="treatmentType" id="treatmentType" value="4">
	...
	<div id="tab">
		  	<div title="背景資料" tabid="serviceData">
		  	...
		  	<div tabid="presentation" title="多專業整合評估簡報">
               		<table cellpadding="0" cellspacing="0" class="l-table-edit" >
               			<tbody>
               				<tr>
               					<%--  <td align="right" class="l-table-edit-td" >姓名:</td>
            ...
            <%-- 				 <td align="right" class="l-table-edit-td">言語治療編號:</td>
		  	...
		  	<div tabid="record" title="特別治療課堂記錄">
