...
<script type="text/javascript">
	...
	function bindingRecordDataGrid(){
		...
		var recordDataGridColumn = [
				                    ...
				                    { display: '活動', name: 'assessDate', width: 150 , type: 'date', format: 'yyyy-MM-dd', editor: { type: 'date'}},
				                  	{ display: '參與課程', name: 'assessDate', width: 150 , type: 'date', format: 'yyyy-MM-dd', editor: { type: 'date'}},
				                  	{ display: '學生表現', name: 'assessDate', width: 150 , type: 'date', format: 'yyyy-MM-dd', editor: { type: 'date'}},
				                  	{ display: '備註', name: 'assessDate', width: 150 , type: 'date', format: 'yyyy-MM-dd', editor: { type: 'date'}},
								];
...
<body>
	<div id="tab">
		  	<div title="背景資料" id="serviceData"><!-- 背景資料 -->
		  		...
		  		<table cellpadding="0" cellspacing="0" class="l-table-edit" >
			        <tbody>
			            <tr>
			                ...
			                <td align="right" class="l-table-edit-td">特別治療編號：</td>
		  	...
		  	<div id="presentation" title="多專業整合評估簡報"><!-- 多專業整合評估簡報 -->
		  		<form action="">
               		<table cellpadding="0" cellspacing="0" class="l-table-edit" >
               			<tbody>
               				<tr>
               				...
               				<tr>
               					 ...
               					 <td align="right" class="l-table-edit-td">評估工具:</td>
               					 <td align="left" class="l-table-edit-td">
               					 	<input width="120px" value="${custCasePojo.recordAdmin }" name="recordAmin" type="text" id="recordAmin" ltype="text" />
               					 </td>
               			...
               			<div class="panel panel-default">
						  <div class="panel-heading">發展能力評估紀錄</div>
						  <div class="panel-body">
						  <div class="inline-group">
						  	<label>評估工具：</label>
						  	<input ltype="text">
		  	...
		  	<div id="plan" title="特別治療計畫"><!-- 特別治療計畫 -->
		  	...
		  	<div id="record" title="特別治療課堂記錄"><!-- 特別治療課堂記錄 -->
		  		<form>
