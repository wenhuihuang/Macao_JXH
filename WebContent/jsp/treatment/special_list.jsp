...
<script type="text/javascript">
        ...
        function addRow(){
        	location.href = "Treatment/add.do?treatmentType=4";
        }
        ...
        function modifyRow(){
        	...
        	if(treatmentID!="" && treatmentID!=null){
	        	location.href = "Treatment/edit.do?treatmentType=4&treatmentID="+treatmentID+"&custID="+custID;        		
        	}
        }
        function deleteRow(){
        	var treatmentID = getRowCell(maingrid,"treatmentID");
        ...
        $(function ()
        {
        	setTabTitle(parent.$("#framecenter"),"特別治療列表") 
            ...
            maingrid = ligerGrid("maingrid",'99%',columns,"Treatment/list.do?treatmentType=4",gridToolBar,false,true);
            $("#pageloading").hide();
        });
