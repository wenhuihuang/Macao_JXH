...
<script type="text/javascript">
	...
	function itemclick(item){
		switch (item.id){
			...
			break;
			case "back":
				location.href="jsp/treatment/job_list.jsp";
			break;
		}
	...
	/* 	if($("#treatmentID").val() != "" && $("#treatmentID").val() != 'null' && $("#treatmentID").val() != 'undefined'){
			setTabTitle(parent.$("#framecenter"),"職業治療編輯")
		}else{
			setTabTitle(parent.$("#framecenter"),"職業治療新增")
		} */
...
<body>
	...
	<input type="hidden" name="treatmentType" id="treatmentType" value="2">
	...
	<div id="tab">
		  	...
		  	<div tabid="presentation" title="職業治療評估簡報"><!-- 職業治療評估簡報 -->
               		<table cellpadding="0" cellspacing="0" class="l-table-edit" >
               			<tbody>
               				<tr>
               					<%--  <td align="right" class="l-table-edit-td" >姓名:</td>
            ...
            <%-- 				 <td align="right" class="l-table-edit-td">言語治療編號:</td>
		  	...
		  	<div tabid="plan" title="職業治療計畫"><!-- 職業治療計畫 -->
		  	...
		  	<div tabid="record" title="職業治療課堂記錄"><!-- 職業治療課堂記錄 -->
