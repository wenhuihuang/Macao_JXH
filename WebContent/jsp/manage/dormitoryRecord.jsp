...
<script type="text/javascript">
        ...
        $(function ()
        {
            ...
            var columns = [
       	                { display: '住客編號', name: 'caseNo', align: 'left', width: 100, minWidth: 60 },
