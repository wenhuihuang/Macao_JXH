...
<script type="text/javascript">
		...
		var groupSettingRecordBudgetDataGridColumn = [
				                    ...
				                    { display: '費用/人', name: 'pay',minWidth:120, type:"text", editor: { type: 'text'}},
	...
	var groupSettingRecordPlanDataGridColumn = [
			                    ...
			                    { display: '活動編號', name: 'actNO', minWidth: 120,type:"text",editor: { type: 'text' }},
			                    { display: '活動名稱', name: 'actName', minWidth: 120,type:"text",editor: { type: 'text'}},
			                    { display: '日期', name: 'billDate', minWidth: 120, type: 'date', format: 'yyyy-MM-dd', editor: { type: 'date'}},
			                    { display: '時間', name: 'time', minWidth: 120, type:"text", editor: { type: 'text'}},
			                    { display: '活動流程', name: 'process', minWidth: 120, type:"text", editor: { type: 'text'}},
			                    { display: '備註', name: 'note', minWidth: 120, type:"text", editor: { type: 'text'}}
			                  ];
	...
	var groupSettingRecordPerformanceDataGridColumn = [
			                    ...
			                    { display: '學員名稱', name: 'fullName',type:"text", minWidth: 120,editor: { type: 'text' }},
			                    { display: '日期', name: 'billDate', type: 'date', minWidth: 120, format: 'yyyy-MM-dd', editor: { type: 'date'}},
			                    ...
			                    { display: '學員表現', name: 'performance', type:"text", minWidth: 120, editor: { type: 'text'}},
			                    { display: '缺席原因', name: 'reason', type:"text", minWidth: 120, editor: { type: 'text'}},
...
<body>
	...
	<div id="tab">
		  	<div title="小組記錄" tabid="groupRecordGrid" class="label-width-90">
